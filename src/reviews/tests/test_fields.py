...
class FieldTests(TestCase):
    def setUp(self):
        ...
        self.doc = DocumentFactory(document_key="HAZOP-related", category=self.category)
    ...
    def test_reviewer_comment_file_name(self):
        ...
        filename = "reviews/HAZOP-related_{:02d}_{}_comments.zip".format(
            self.doc.current_revision, self.user.id
        )
        self.assertEqual(review.comments.name, filename)
    ...
    def test_leader_comment_file_name(self):
        ...
        self.assertEqual(
            review.comments.name, "reviews/HAZOP-related_01_leader_comments.zip"
        )
    ...
    def test_approver_comment_file_name(self):
        ...
        self.assertEqual(
            review.comments.name, "reviews/HAZOP-related_01_GTG_comments.zip"
        )
