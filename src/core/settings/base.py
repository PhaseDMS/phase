...
STATICFILES_DIRS = (DJANGO_ROOT.child("static"),)
...
FIXTURE_DIRS = (DJANGO_ROOT.child("fixtures"),)
...
LOGGING = {
    ...
    "filters": {
        ...
        "require_sentry_activated": {"()": "core.log.RequireSentryActivated"},
    },
    "formatters": {
...
PIPELINE = {
    ...
    "STYLESHEETS": {
        ...
        "list": {
            "source_filenames": ("css/selectize.css",),
        ...
        "charts": {
            "source_filenames": ("css/charts.css",),
