...
from distriblists.forms import DistributionListImportForm, DistributionListExportForm
...
class BaseListExport(LoginRequiredMixin, FormView):
    ...
    def get_form_kwargs(self):
        ...
        kwargs.update(
            {"user": self.request.user, "categories": self.request.user_categories}
        )
        return kwargs
...
class DistributionListExport(BaseListExport):
    ...
    def form_valid(self, form):
        ...
        filename = "lists_{}_{}.xlsx".format(category.organisation.slug, category.slug)
