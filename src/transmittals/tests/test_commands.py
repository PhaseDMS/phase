...
class ImportCommandTests(TestCase):
    def setUp(self):
        ...
        self.doc_category_path = "{}/{}".format(
            doc_category.organisation.slug, doc_category.category_template.slug
        )
        ...
        self.trs_category_path = "{}/{}".format(
            trs_category.organisation.slug, trs_category.category_template.slug
        )
    ...
    def prepare_import_dir(self, directory=None):
        ...
        if directory is not None:
            src = os.path.join(os.path.dirname(__file__), "fixtures", directory)
